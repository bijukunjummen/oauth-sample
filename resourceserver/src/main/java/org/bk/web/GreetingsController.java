...
public class GreetingsController {
    @PreAuthorize("hasRole('ROLE_USER') or #oauth2.hasScope('resource.read')")
    ...
    @PreAuthorize("hasRole('ROLE_USER') or #oauth2.hasScope('resource.write')")
    ...
    @PreAuthorize("hasRole('ROLE_USER') or #oauth2.hasScope('resource.invalid')")
